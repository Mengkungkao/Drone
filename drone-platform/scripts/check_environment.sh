...
python3 -c 'import sys, rclpy; assert sys.version_info[:2] == (3, 10); print("PASS Humble Python:", sys.version.split()[0])' || { echo 'FAIL: Humble requires the Ubuntu Python 3.10 environment'; fail=1; }
